...
\vspace*{1.5cm}% start 8 cm from the top of the page}
    ...
    \begin{center}
        ...
        \cvtag{\json{['skills'][1]['keywords'][9]}}        
        \cvtag{\json{['skills'][1]['keywords'][10]}}        
...
%%%%% MAIN SECTION %%%%%%%%%%%%%%%%%%%%
    \adjustbox{valign=t}{\begin{minipage}{13.3cm}
        ...
        Decade+ in \hitext{\textbf{applied data analysis}} with expertise in \emph{code development and deployment, data preparation, distributed computing, machine learning, and hypothesis testing}.
        ...
        \MySectionNoFill{From Jun. 2023}{}{Quantitative Researcher}{}{PLAYMETECH, London}{}{}}
                  \footnotesize{
                    ...
                    \item Lead the design and deployment \hitext{stochastic models} to predict match and odds in different sports betting markets using a data based approach. 
                    \item \hitext{Develop ML based strategies} for sports betting with \hitext{{\it{Bayesian} and \it{Reinforcement}\,}} techniques and model their intrinsic risk. Document and communicate strategies transparently. 
                    \item Create database processing pipelines from several \hitext{SQL and NoSQL} sources.
                    \end{itemize}
                  }
                  %\small{\emph{Research}}
        \vspace*{0.22cm}                        
        \MySectionNoLoc{\json{['work'][1]['startDate']}--\json{['work'][1]['endDate']}}{ued-blackonwhite.png}{\json{['work'][1]['name']}}{ATLAS Experiment}{\json{['work'][1]['location']}}{\json{['work'][1]['position']}}{\small{\footnotesize{\json{['work'][1]['highlights'][1]}}}}%{\json{['work'][1]['summary']}}
                  %\small{\emph{Research}}
        \footnotesize{
          \begin{itemize}
            %\item \json{['work'][1]['highlights'][1]}
    ...
    % Education
        ...
        \MySectionNoLoc{\json{['work'][3]['startDate']}--\json{['work'][3]['endDate']}}{shef.png}{\json{['work'][3]['name']}}{ATLAS Experiment}{\json{['work'][3]['location']}}{\json{['work'][3]['position']}}{\href{https://etheses.whiterose.ac.uk/25836/1/thesis_final.pdf}{\emph{Thesis:} Probing the Beyond Standard Model Higgs Sector using ATLAS}}%\json{['work'][3]['summary']}
                  %% \footnotesize{
                  %%   \begin{itemize}
    ...
    \\\\
        ...
        \publication{\json{['publications'][2]['name']}}{}{Search for Heavy Higgs Boson decaying into Two Tau Leptons with the ATLAS Detector Using $pp$ pp collisions at $\sqrt{s}$ = 13 TeV}{2020}{ATLAS}{\json{['publications'][2]['url']}}
        %\publication{\json{['publications'][2]['name']}}{\json{['publications'][2]['releaseDate']}}{Search for Heavy Higgs Boson decaying into Two Tau Leptons with the ATLAS Detector Using $pp$ pp collisions at $\sqrt{s}$ = 13 TeV}{\json{['publications'][2]['publisher']}}{ATLAS}{\json{['publications'][2]['url']}}        
