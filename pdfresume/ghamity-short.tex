...
\vspace*{1.5cm}% start 8 cm from the top of the page}
    ...
    \vspace*{1.2cm} % text starts 1cm under the top of the minipage
        ...
        & \node{\href{https://www.linkedin.com/in/guillermo-hamity}{ghamity}};\\
        \node{\faGithub}; 
...
%%%%% MAIN SECTION %%%%%%%%%%%%%%%%%%%%
    \adjustbox{valign=t}{\begin{minipage}{13.3cm}
        ...
        \MySectionNoFill{From Jun. 2023}{}{Quantitative Researcher}{}{PLAYMETECH, London}{}{}}
                  \footnotesize{
                    ...
                    \item Lead the design and deployment of \hitext{stochastic models} to predict match and odds in different sports betting markets using a data based approach. 
        ...
        \vspace*{0.22cm}                        
        \MySectionNoLoc{2019--May 2023}{ued-blackonwhite.png}{Postdoctoral Research Associate}{ATLAS Experiment}{The University of Edinburgh}{Research}{\small{\footnotesize{Active in all areas of physics \textbf{analysis}, incl. data preparation, software development/maintenance, algorithm design/deployment, and statistical intepretation. Responsibilities in \textbf{lecturing}, \textbf{supervising} and \textbf{leadership}.}}}
        \footnotesize{
          \begin{itemize}
    ...
    % Education
        ...
        \MySectionNoLoc{2015--2019}{shef.png}{PhD in High Energy Physics}{ATLAS Experiment}{The University of Sheffield}{PhD candidate}{\href{https://etheses.whiterose.ac.uk/25836/1/thesis_final.pdf}{\emph{Thesis:} Probing the Beyond Standard Model Higgs Sector using ATLAS}}
        \\\\
