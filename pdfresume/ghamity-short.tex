...
%%%%% MAIN SECTION %%%%%%%%%%%%%%%%%%%%
    \adjustbox{valign=t}{\begin{minipage}{13.3cm}
        ...
        \begin{itemize}
          ...
          \item Remain at the forefront of technological advancements in the field, exemplified by the \textbf{ML lectures} delivered at the \textbf{University of Edinburgh}.
        \end{itemize}
